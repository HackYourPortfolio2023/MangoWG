...
def generateNewHTML(userData):
    ...
    with tag('html', lang='en'):
        ...
        with tag('body'):
            # Navbar
            with tag('nav', klass='navbar navbar-expand-sm bg-dark navbar-dark sticky-top'):
            ...
            # Jumbotron
            with tag('div', klass='jumbotron jumbotron-fluid', style='margin-bottom: 0'):
                    ...
                    with tag('div', klass='col-lg-4 d-flex align-items-center justify-content-center flex-wrap'):
                        ...
                        with tag('div', klass='d-flex flex-column align-items-center justify-content-center'):
                            with tag('h1'):
                                text(userData['name'])
                            with tag('p'):
                                text('Some text that represents "Me"...')

            # Content
            with tag('div', klass='row d-flex align-items-center justify-content-center'):
                    ...
                    with tag('div', klass='container', style='padding: 20px'):
                        with tag('div', klass='row'):
                            with tag('div', klass='col-md-4'):
                                ...
                                with tag('p'):
                                    text(
                                        'I am a web developer with experience in HTML, CSS, JavaScript, and PHP. I am passionate about creating beautiful and functional websites.')
                            with tag('div', klass='col-md-4'):
                                with tag('h3'):
                                    text('Contact')
                                with tag('p'):
                                    text('Email:')
                                    with tag('a', href='mailto:youremail@example.com'):
                            ...
                            with tag('div', klass='col-md-4'):
                                with tag('h3'):
                                    text('Social Media')
                                with tag('a', klass='btn btn-outline-light', href='#'):
